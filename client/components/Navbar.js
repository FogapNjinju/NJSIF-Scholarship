        ...
        <div className="flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center text-white">
            ...
            <span className="ml-3 flex flex-col">
              ...
              <span className="brand-caption !ml-0 mt-1">Scholarship</span>
            </span>
          </Link>
          <div className="hidden items-center gap-2 md:flex">
            ...
            <Link href="/fr" className="btn-secondary !min-h-10 !px-4 !py-2">
              FR
            </Link>
            <Link href="/apply" className="btn-primary !min-h-10 !px-5 !py-2">
              Apply
            </Link>
          </div>
        ...
        {open && (
          <div className="animate-fade-in mt-4 rounded-[2rem] border border-white/10 bg-slate-900/95 p-4 md:hidden">
            <div className="flex flex-col gap-2 text-sm text-slate-200">
              <Link href="/" className="rounded-2xl px-4 py-2.5 transition hover:bg-white/5 hover:text-white" onClick={() => setOpen(false)}>
                Home
              </Link>
              <Link href="/about" className="rounded-2xl px-4 py-2.5 transition hover:bg-white/5 hover:text-white" onClick={() => setOpen(false)}>
                About
              </Link>
