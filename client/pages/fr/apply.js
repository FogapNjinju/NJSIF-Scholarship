            ...
            <div className="surface-card">
              ...
              <div className="surface-panel mt-10 space-y-6">
                <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 px-4 py-4">
                  ...
                  <p className="mt-2 text-2xl font-semibold text-white">30 juin 2026</p>
                  <p className="mt-2 text-sm text-slate-300">Il reste environ <span className="font-semibold text-white">{daysLeft} jours</span> pour envoyer votre candidature.</p>
                </div>
